...
extension Module {
	public enum Feature: String, CaseIterable, ModuleFeatureType {
		case Repository
...
extension Module {
	public enum Domain: String, CaseIterable, ModuleDomainType {
		case Git
		public var name: String { rawValue }
	}
}
...
extension Module {
	public enum Data: String, CaseIterable, ModuleDataType {
		case Git
		public var name: String { rawValue }
	}
}
...
extension Module {
	public enum Core: String, CaseIterable, ModuleCoreType {
		case GitCredential
		case RepositoryDiff
		case RepositoryUI
		public var name: String { rawValue }
