...
public struct EqualWidthHSplitView<Leading: View, Center: View, Trailing: View>: NSViewRepresentable
{
	...
	public func makeNSView(context: Context) -> ProportionalSplitView {
